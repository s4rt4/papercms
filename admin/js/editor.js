/* ========================================
   ADMIN PAPER EDITOR 
   (Modified for admin folder - API paths point to parent)
   ======================================== */
...
class PaperEditor {
    ...
    insertCodeBlock() { this.toolbar.insertCodeBlock(); }
    ...
    bindResizeEvents() {
        ...
        this.editor.addEventListener('click', (e) => {
            ...
            if (tag === 'IMG' || tag === 'VIDEO' || tag === 'IFRAME' ||
                ...
                imageToolbar.style.top = (rect.top + scrollTop - 70) + 'px';
    ...
    initWordCount() {
        ...
        this.editor.addEventListener('paste', () => setTimeout(update, 100));
